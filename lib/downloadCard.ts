...
export async function downloadVoucherCard(voucher: Voucher): Promise<void> {
  ...
  gLine.addColorStop(0, "#c9a84c");
  gLine.addColorStop(1, "#e8c96d");
  ctx.fillStyle = gLine;
  ...
  ctx.lineWidth = 1;
  ctx.beginPath();
  ctx.roundRect(w - 390, 20, 178, 20, 10);
  ctx.fill();
  ctx.stroke();
  txt(
  ...
  gGold.addColorStop(0, "#c9a84c");
  gGold.addColorStop(0.5, "#f5e09a");
  gGold.addColorStop(1, "#e8c96d");
  ctx.fillStyle = gGold;
  ctx.font = 'bold 24px "Playfair Display",serif';
  ctx.letterSpacing = "normal";
  ctx.fillText("Rp 500.000", 36, h - 50);
  txt(
    "berlaku di semua travel umroh indonesia",
    36,
    h - 22,
    "400 8px Tajawal,sans-serif",
